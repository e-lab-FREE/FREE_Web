...
urlpatterns = [
    ...
    path('api/v1/statusexecution/<int:execution_id>', views.ExecutionStatusAPIView.as_view(), name='api-execution-status'),
    ...
    path('api/v1/getexecution/<int:apparatus_id>', views.ExecutionStatusSubmitAPI.as_view(), name='api-execution-submit'), # need to be added by Pavel send a mail
